...
public class UserLogin extends JDialog implements ActionListener {
	...
	class BackImage extends JPanel {
		...
		public BackImage() {
			try {
	    		im = ImageIO.read(new File("/home/acer/Order_Management_System_-Java--master/MyRestaurant/image/login.jpg"));
			} catch (IOException e) {
	...
	//		if(res.equals("manager")||res.equals("supervisor")||res.equals("administrator") || res.equals("ping")) {
            if (!res.equals("")){
	//			new Windows1();
